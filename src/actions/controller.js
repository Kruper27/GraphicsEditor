...
import RectInterface from '../models/Group'
...
/*
    func that connect store and updates history
 */
...
/*
    func that connect store and make rollback
 */
export const undo = () => {
    const state = store.getState()
...
/*
    func that connect store to go 'future' step
*/
export const redo = () => {
    const state = store.getState()
...
/*
    func that connect store and add new object
*/
...
/*
    func that transform existed object
*/
...
/*
    func that change color for set of objects
 */
...
/*
    func that moves set of objects on Max priority(on 1 layer)
*/
...
/*
    func that moves selected set on min priority(second+ layer)
* */
...
/*
    func that make group of objects
*/
...
/*func that delete selected set of objects*/
...
/*select set of objects by cursor choosed zone*/
...
/*func that select all objects on canvas*/
